...
TRACEHEADER
    ...
    it "should add a new received header after the other received headers if they exist" do
      ...
      @traced_header['Received'] = "from agw2 by xxx.xxxx.xxx; Sun, 8 May 2005 12:30:23 -0500"
      expect(@traced_header.fields[0].addresses).to eq ['xxx@xxxx.xxxtest']
      expect(@traced_header.fields[1].to_s).to eq 'from xxx.xxxx.xxx by xxx.xxxx.xxx with ESMTP id 6AAEE3B4D23 for <xxx@xxxx.xxx>; Sun, 8 May 2005 12:30:23 -0500'
      expect(@traced_header.fields[2].to_s).to eq 'from xxx.xxxx.xxx by xxx.xxxx.xxx with ESMTP id j48HUC213279 for <xxx@xxxx.xxx>; Sun, 8 May 2005 12:30:13 -0500'
      expect(@traced_header.fields[3].to_s).to eq 'from conversion-xxx.xxxx.xxx.net by xxx.xxxx.xxx id <0IG600901LQ64I@xxx.xxxx.xxx> for <xxx@xxxx.xxx>; Sun, 8 May 2005 12:30:12 -0500'
      expect(@traced_header.fields[5].to_s).to eq "from agw2 by xxx.xxxx.xxx; Sun, 8 May 2005 12:30:23 -0500"
  ...
  describe "encoding" do
    ...
    if '1.9'.respond_to?(:force_encoding)
      it "should blow up on encoding mismatches" do
        ...
        expect { header.encoded }.not_to raise_error
      end
    end
  end
