...
describe Mail::Encodings do
  ...
  describe "quoted-printable Encoding" do
    ...
    it "should return the QuotedPrintable Encoding class" do
      expect(Mail::Encodings.get_encoding('quotedprintable')).to eq Mail::Encodings::QuotedPrintable
    end
  ...
  describe "altering an encoded text to decoded and visa versa" do
    ...
    describe "unquote and convert to" do
      ...
      it "should unquote and convert to from invalid encoding" do
        ...
        expect(b.encoding).to eq Encoding::UTF_8
        expect(b).to eq "invalid �"
      end
  ...
  describe "address encoding" do
    ...
    it "should handle malformed strings" do
      expect { Mail::Encodings.value_decode( "?==?WINDOWS-1252?Q?Abundance?=" ) }.not_to raise_error
    end
  end

  describe "uuencode Encoding" do
    it "should return true for uuencode" do
      expect(Mail::Encodings.defined?('uuencode')).to eq true
    end
    ...
    it "should return the UUEncode Encoding class" do
      expect(Mail::Encodings.get_encoding('uuencode')).to eq Mail::Encodings::UUEncode
    end
